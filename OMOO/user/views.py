...
from .models import CustomUser, Customer, Rider
...
from .forms import (AdminSignupForm, CustomerAddForm, InventoryManagerSignupForm,
                    ManagerSignupForm, RiderAddForm, StaffSignupForm)
...
class RiderAddView(CreateView):

    model = Rider
    form_class = RiderAddForm
    success_url = reverse_lazy("rider-list")
    template_name = "user/medical_store_signup.html"

    def get_context_data(self, **kwargs):
        context = super(RiderAddView, self).get_context_data(**kwargs)
...
class RiderList(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(RiderList, self).get_context_data(**kwargs)
        context['distributor_open'] = True
        return context
...
class RiderDelete(DeleteView):
    ...
    def get_context_data(self, **kwargs):
        context = super(RiderDelete, self).get_context_data(**kwargs)
        context['distributor_open'] = True
        return context
...
class RiderUpdate(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        context = super(RiderUpdate, self).get_context_data(**kwargs)
        context['distributor_open'] = True
        return context
